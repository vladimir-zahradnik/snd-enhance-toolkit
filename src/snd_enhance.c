...
void snd_enhance_specsub(double * fft_data, int fft_size, fftw_plan fft_forw, fftw_plan fft_back, noise_est_func_t noise_estimation, int datalen, int samplerate)
{
...
void snd_enhance_mmse(double * fft_data, int fft_size, fftw_plan fft_forw, fftw_plan fft_back, noise_est_func_t noise_estimation, int datalen, int samplerate)
{
  /* initialize variables */
  double * y_ps = init_buffer_dbl (fft_size/2 + 1); /* power spectrum */
  double * y_phase = init_buffer_dbl (fft_size/2 + 1); /* phase */
...
void snd_enhance_wiener_as(double * fft_data, int fft_size, fftw_plan fft_forw, fftw_plan fft_back, noise_est_func_t noise_estimation, int datalen, int samplerate)
{
  /* initialize variables */
  double * y_ps = init_buffer_dbl (fft_size/2 + 1); /* power spectrum */
  double * noise_ps = init_buffer_dbl (fft_size/2 + 1); /* noise power spectrum */
  ...
  static double posteri_prev [FFT_MAX/2 + 1]; /* needs to be static array, because it must remember its previous state */
...
void snd_enhance_wiener_iter(double * fft_data, int fft_size, fftw_plan fft_forw, fftw_plan fft_back, noise_est_func_t noise_estimation, int datalen, int samplerate)
{
  /* initialize variables */
...
void snd_enhance_residual(double * fft_data, int fft_size, fftw_plan fft_forw, fftw_plan fft_back, noise_est_func_t noise_estimation, int datalen, int samplerate)
{
  /* initialize variables */
  double * y_ps = init_buffer_dbl (fft_size/2 + 1); /* power spectrum */
  double * y_phase = init_buffer_dbl (fft_size/2 + 1); /* phase */
